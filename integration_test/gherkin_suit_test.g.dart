...
part of 'gherkin_suit_test.dart';
...
class _CustomGherkinIntegrationTestRunner extends GherkinIntegrationTestRunner {
  ...
  void testFeature0() {
    runFeature(
      ...
      run: () {
        runScenario(
          name: 'Успешное заполнение данных',
          description: null,
          path:
              '/Users/ksenia/Developer/qa-summer-school-23/examples/profile/./integration_test/features/profile.feature',
          tags: <String>[],
          steps: [
            (
            ...
            (
              ...
              return await runStep(
                name: 'И Я указываю день рождения "1998-11-14"',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
            ...
            (
              ...
              return await runStep(
                name: 'И Я перехожу к редактированию',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
            ...
            (
              ...
              return await runStep(
                name: 'Тогда Я вижу заполненное поле фамилия',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
            ...
            (
              ...
              return await runStep(
                name: 'И Я вижу заполненное поле имя',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
            ...
            (
              ...
              return await runStep(
                name: 'И Я вижу заполненное поле отчество',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
